...
We use 2000+ QRcode and Barcode pictures to train this model.The result is:

![image](https://github.com/1luoruikang1/YOLOv5-Lite-master/blob/master/runs/train/exp54/results.png)
