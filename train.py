...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='[train, test] images sizes')
    ...
    parser.add_argument('--image_weights', action='store_true', help='use weighted images selection for training')
