...
def main():
    ...
    parser.add_argument('--img-path', type=str, default=r'E:\pytorch\YOLOv5-Lite-master\sample/0111.jpg', help='input images path')
    parser.add_argument('--img-size', type=int, default=800, help="input images size")
